...
namespace NopStation.Plugin.SMS.Vonage.Areas.Admin.Infrastructure
{
    public class MapperConfiguration : Profile, IOrderedMapperProfile
    {
        public MapperConfiguration()
        {
            ...
            CreateMap<VonageSettings, ConfigurationModel>()
            ...
            CreateMap<ConfigurationModel, VonageSettings>();

...
{
    public class QueuedVonageSmsController : NopStationAdminController
    {
        #region Fields
        ...
        public QueuedVonageSmsController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.VonageSms.QueuedSmss.Deleted"));

...
{
    public class BulkSmsTemplateController : NopStationAdminController
    {
        #region Fields
        ...
        public BulkSmsTemplateController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Edit(SmsTemplateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.BulkSms.SmsTemplates.Updated"));

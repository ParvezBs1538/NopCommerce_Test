...
{
    public class QueuedBulkSmsController : NopStationAdminController
    {
        #region Fields
        ...
        public QueuedBulkSmsController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.BulkSms.QueuedSmss.Deleted"));

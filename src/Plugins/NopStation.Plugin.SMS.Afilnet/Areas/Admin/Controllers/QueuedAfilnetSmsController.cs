...
{
    public class QueuedAfilnetSmsController : NopStationAdminController
    {
        #region Fields
        ...
        public QueuedAfilnetSmsController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.Afilnet.QueuedSmss.Deleted"));

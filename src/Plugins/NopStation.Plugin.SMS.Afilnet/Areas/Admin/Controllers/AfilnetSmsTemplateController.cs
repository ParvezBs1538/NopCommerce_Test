...
{
    public class AfilnetSmsTemplateController : NopStationAdminController
    {
        #region Fields
        ...
        public AfilnetSmsTemplateController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Edit(SmsTemplateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.Afilnet.SmsTemplates.Updated"));

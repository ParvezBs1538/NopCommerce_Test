...
{
    public class TeleSignSmsTemplateController : NopStationAdminController
    {
        #region Fields
        ...
        public TeleSignSmsTemplateController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Edit(SmsTemplateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.TeleSignSms.SmsTemplates.Updated"));

...
{
    public class QueuedTeleSignSmsController : NopStationAdminController
    {
        #region Fields
        ...
        public QueuedTeleSignSmsController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.TeleSignSms.QueuedSmss.Deleted"));

...
namespace NopStation.Plugin.SMS.TeleSign.Services
{
    public partial class WorkflowSmsService : IWorkflowNotificationService
    {
        ...
        private readonly ISmsTokenProvider _teleSignsmsTokenProvider;
        ...
        public WorkflowSmsService(ICustomerService customerService,
            ...
            ISmsTokenProvider teleSignsmsTokenProvider,
            ...
            TeleSignSettings teleSignSettings)
        {
            ...
            _teleSignsmsTokenProvider = teleSignsmsTokenProvider;
        ...
        protected string GetFormattedPhoneNumber(string phoneNumber)
        {
            ...
            if (_teleSignSettings.CheckPhoneNumberRegex)
            {
                var match = Regex.Match(phoneNumber, _teleSignSettings.PhoneNumberRegex, RegexOptions.IgnoreCase);
            ...
            if (_teleSignSettings.CheckIntlDialCode)
            {
                if (!phoneNumber.StartsWith(_teleSignSettings.IntlDialCode))
                {
                    if (_teleSignSettings.RemoveFirstNDigitsWhenLocalNumber > 0)
                        phoneNumber = phoneNumber[_teleSignSettings.RemoveFirstNDigitsWhenLocalNumber..];

                    phoneNumber = _teleSignSettings.IntlDialCode + phoneNumber;
                }
            }
        ...
        public virtual async Task<IList<int>> SendCustomerRegisteredNotificationMessageAsync(Customer customer, int languageId)
        {
            ...
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);

            return await notificationTemplates.SelectAwait(async smsTemplate =>
            {
                var tokens = new List<Token>(commonTokens);
                await _teleSignsmsTokenProvider.AddStoreTokensAsync(tokens, store);
        ...
        public virtual async Task<IList<int>> SendOrderPlacedVendorNotificationAsync(Order order, Vendor vendor, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _teleSignsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId, vendor.Id);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendOrderPlacedAdminNotificationAsync(Order order, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _teleSignsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendShipmentSentCustomerNotificationAsync(Shipment shipment, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _teleSignsmsTokenProvider.AddShipmentTokensAsync(commonTokens, shipment, languageId);
            await _teleSignsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendShipmentDeliveredCustomerOTPNotificationAsync(Shipment shipment, string otp, int languageId)
        {
            ...
            await _teleSignsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            _teleSignsmsTokenProvider.AddOTPTokens(commonTokens, otp);
        ...
        public virtual async Task<IList<int>> SendOrderRefundedAdminNotificationAsync(Order order, decimal refundedAmount, int languageId)
        {
            ...
            var commonTokens = new List<Token>();
            await _teleSignsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _teleSignsmsTokenProvider.AddOrderRefundedTokensAsync(commonTokens, order, refundedAmount);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendNewForumTopicMessageAsync(Customer customer, ForumTopic forumTopic, Forum forum, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _teleSignsmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopic);
            await _teleSignsmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            ...
            Forum forum, int friendlyForumTopicPageIndex, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _teleSignsmsTokenProvider.AddForumPostTokensAsync(commonTokens, forumPost);
            await _teleSignsmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopics, friendlyForumTopicPageIndex, forumPost.Id);
            await _teleSignsmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendPrivateMessageNotificationAsync(PrivateMessage privateMessage, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _teleSignsmsTokenProvider.AddPrivateMessageTokensAsync(commonTokens, privateMessage);
            await _teleSignsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);

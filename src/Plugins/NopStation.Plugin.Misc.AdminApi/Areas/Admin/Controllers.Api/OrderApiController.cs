...
public partial class OrderApiController : BaseAdminApiController
{
    ...
    [HttpPost]
    public virtual async Task<IActionResult> ExportXmlAll([FromBody] BaseQueryModel<OrderSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> ExportExcelAll([FromBody] BaseQueryModel<OrderSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    public virtual async Task<IActionResult> ImportFromXlsx()
    {
        ...
        try
        {
            ...
            return Ok(await _localizationService.GetResourceAsync("Admin.Orders.Imported"));
        }
        catch (Exception exc)
        {
    ...
    [HttpPost("{id}/{online}")]
    public virtual async Task<IActionResult> PartiallyRefundOrderPopup(int id, bool online, [FromBody] BaseQueryModel<OrderModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
        ...
        try
        {
            ...
            if (amountToRefund <= decimal.Zero)
                return BadRequest("Enter amount to refund");
            ...
            return BadRequestWrap(model, errors: errors);
        }
        catch (Exception exc)
        {
            return InternalServerError(exc.Message);
    ...
    [HttpPost("{id}")]
    public virtual async Task<IActionResult> ChangeOrderStatus(int id, [FromBody] BaseQueryModel<OrderModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> AddressEdit([FromBody] BaseQueryModel<OrderAddressModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> ShipmentListSelect([FromBody] BaseQueryModel<ShipmentSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> ShipmentsByOrder([FromBody] BaseQueryModel<OrderShipmentSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> ShipmentsItemsByShipmentId([FromBody] BaseQueryModel<ShipmentItemSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
        ...
        if (shipment == null)
            return NotFound("No shipment found with the specified id");

        //a vendor should have access only to his products
        if (await _workContext.GetCurrentVendorAsync() is not null && !await HasAccessToShipmentAsync(shipment))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> AddShipment([FromBody] BaseQueryModel<ShipmentModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
        ...
        if (shipmentItems.Any())
        {
            ...
            return Created(shipment.Id, await _localizationService.GetResourceAsync("Admin.Orders.Shipments.Added"));
        }

        return BadRequest(await _localizationService.GetResourceAsync("Admin.Orders.Shipments.NoProductsSelected"));
    }
    ...
    public virtual async Task<IActionResult> DeleteShipment(int id)
    {
        ...
        return Ok(await _localizationService.GetResourceAsync("Admin.Orders.Shipments.Deleted"));
    }

    [HttpPost]
    public virtual async Task<IActionResult> SetTrackingNumber([FromBody] BaseQueryModel<ShipmentModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> SetShipmentAdminComment([FromBody] BaseQueryModel<ShipmentModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> EditShippedDate([FromBody] BaseQueryModel<ShipmentModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
        ...
        try
        {
            ...
            {
                return BadRequest("Enter shipped date");
            }
    ...
    [HttpPost]
    public virtual async Task<IActionResult> EditReadyForPickupDate([FromBody] BaseQueryModel<ShipmentModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
        ...
        try
        {
            if (!model.ReadyForPickupDateUtc.HasValue)
                return BadRequest("Enter ready for pickup date");
    ...
    [HttpPost]
    public virtual async Task<IActionResult> EditDeliveryDate([FromBody] BaseQueryModel<ShipmentModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
        ...
        try
        {
            ...
            {
                return BadRequest("Enter delivery date");
            }
    ...
    [HttpPost]
    public virtual async Task<IActionResult> PdfPackagingSlipAll([FromBody] BaseQueryModel<ShipmentSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
        ...
        if (!shipments.Any())
        {
            return BadRequest(await _localizationService.GetResourceAsync("Admin.Orders.Shipments.NoShipmentsSelected"));
        }
        ...
        try
        {
            ...
            return File(bytes, MimeTypes.ApplicationZip, "packagingslips.zip");
        }
        catch (Exception exc)
        {
            return InternalServerError(exc.Message);
    ...
    public virtual async Task<IActionResult> PdfPackagingSlipSelected([FromBody] BaseQueryModel<ICollection<int>> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> SetAsShippedSelected([FromBody] BaseQueryModel<ICollection<int>> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> SetAsDeliveredSelected([FromBody] BaseQueryModel<ICollection<int>> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> OrderNotesSelect([FromBody] BaseQueryModel<OrderNoteSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    public virtual async Task<IActionResult> OrderNoteAdd(int orderId, int downloadId, bool displayToCustomer, string message)
    {
        ...
        if (string.IsNullOrEmpty(message))
            return BadRequest(await _localizationService.GetResourceAsync("Admin.Orders.OrderNotes.Fields.Note.Validation"));
    ...
    public virtual async Task<IActionResult> OrderNoteDelete(int id, int orderId)
    {
        ...
        if (orderNote == null)
            return NotFound("No order note found with the specified id");
    ...
    [HttpPost]
    public virtual async Task<IActionResult> BestsellersBriefReportByQuantityList([FromBody] BaseQueryModel<BestsellerBriefSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> BestsellersBriefReportByAmountList([FromBody] BaseQueryModel<BestsellerBriefSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> OrderAverageReportList([FromBody] BaseQueryModel<OrderAverageReportSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    [HttpPost]
    public virtual async Task<IActionResult> OrderIncompleteReportList([FromBody] BaseQueryModel<OrderIncompleteReportSearchModel> queryModel)
    {
        if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageOrders))
            return AdminApiAccessDenied();
    ...
    public virtual async Task<IActionResult> LoadOrderStatistics(string period)
    {
        ...
        return Ok(result.ToGenericResponse<object>());
    }

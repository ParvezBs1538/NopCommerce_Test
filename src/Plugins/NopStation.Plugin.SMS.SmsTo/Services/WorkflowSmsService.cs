...
namespace NopStation.Plugin.SMS.SmsTo.Services
{
    public partial class WorkflowSmsService : IWorkflowNotificationService
    {
        ...
        private readonly ISmsTokenProvider _smsTosmsTokenProvider;
        ...
        public WorkflowSmsService(ICustomerService customerService,
            ...
            ISmsTokenProvider smsTosmsTokenProvider,
            ...
            SmsToSettings smsToSettings)
        {
            ...
            _smsTosmsTokenProvider = smsTosmsTokenProvider;
        ...
        protected string GetFormattedPhoneNumber(string phoneNumber)
        {
            ...
            if (_smsToSettings.CheckPhoneNumberRegex)
            {
                var match = Regex.Match(phoneNumber, _smsToSettings.PhoneNumberRegex, RegexOptions.IgnoreCase);
            ...
            if (_smsToSettings.CheckIntlDialCode)
            {
                if (!phoneNumber.StartsWith(_smsToSettings.IntlDialCode))
                {
                    if (_smsToSettings.RemoveFirstNDigitsWhenLocalNumber > 0)
                        phoneNumber = phoneNumber[_smsToSettings.RemoveFirstNDigitsWhenLocalNumber..];

                    phoneNumber = _smsToSettings.IntlDialCode + phoneNumber;
                }
            }
        ...
        public virtual async Task<IList<int>> SendCustomerRegisteredNotificationMessageAsync(Customer customer, int languageId)
        {
            ...
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);

            return await notificationTemplates.SelectAwait(async smsTemplate =>
            {
                var tokens = new List<Token>(commonTokens);
                await _smsTosmsTokenProvider.AddStoreTokensAsync(tokens, store);
        ...
        public virtual async Task<IList<int>> SendOrderPlacedVendorNotificationAsync(Order order, Vendor vendor, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _smsTosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId, vendor.Id);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendOrderPlacedAdminNotificationAsync(Order order, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _smsTosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendShipmentSentCustomerNotificationAsync(Shipment shipment, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _smsTosmsTokenProvider.AddShipmentTokensAsync(commonTokens, shipment, languageId);
            await _smsTosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendShipmentDeliveredCustomerOTPNotificationAsync(Shipment shipment, string otp, int languageId)
        {
            ...
            await _smsTosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            _smsTosmsTokenProvider.AddOTPTokens(commonTokens, otp);
        ...
        public virtual async Task<IList<int>> SendOrderRefundedAdminNotificationAsync(Order order, decimal refundedAmount, int languageId)
        {
            ...
            var commonTokens = new List<Token>();
            await _smsTosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _smsTosmsTokenProvider.AddOrderRefundedTokensAsync(commonTokens, order, refundedAmount);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendNewForumTopicMessageAsync(Customer customer, ForumTopic forumTopic, Forum forum, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _smsTosmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopic);
            await _smsTosmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            ...
            Forum forum, int friendlyForumTopicPageIndex, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _smsTosmsTokenProvider.AddForumPostTokensAsync(commonTokens, forumPost);
            await _smsTosmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopics, friendlyForumTopicPageIndex, forumPost.Id);
            await _smsTosmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendPrivateMessageNotificationAsync(PrivateMessage privateMessage, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _smsTosmsTokenProvider.AddPrivateMessageTokensAsync(commonTokens, privateMessage);
            await _smsTosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);

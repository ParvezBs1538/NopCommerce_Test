...
namespace NopStation.Plugin.SMS.SmsTo.Areas.Admin.Infrastructure
{
    public class MapperConfiguration : Profile, IOrderedMapperProfile
    {
        public MapperConfiguration()
        {
            ...
            CreateMap<SmsToSettings, ConfigurationModel>()
                ...
                .ForMember(model => model.SenderId_OverrideForStore, options => options.Ignore());
            CreateMap<ConfigurationModel, SmsToSettings>();

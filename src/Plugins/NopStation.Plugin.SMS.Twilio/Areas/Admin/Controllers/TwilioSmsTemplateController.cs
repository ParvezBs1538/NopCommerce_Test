...
{
    public class TwilioSmsTemplateController : NopStationAdminController
    {
        #region Fields
        ...
        public TwilioSmsTemplateController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Edit(SmsTemplateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.Twilio.SmsTemplates.Updated"));

...
{
    public class QueuedTwilioSmsController : NopStationAdminController
    {
        #region Fields
        ...
        public QueuedTwilioSmsController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.Twilio.QueuedSmss.Deleted"));

...
namespace NopStation.Plugin.SMS.Twilio.Services
{
    public partial class WorkflowSmsService : IWorkflowNotificationService
    {
        ...
        private readonly ISmsTokenProvider _twiliosmsTokenProvider;
        ...
        public WorkflowSmsService(ICustomerService customerService,
            ...
            ISmsTokenProvider twiliosmsTokenProvider,
            ...
            TwilioSettings twilioSettings)
        {
            ...
            _twiliosmsTokenProvider = twiliosmsTokenProvider;
        ...
        protected string GetFormattedPhoneNumber(string phoneNumber)
        {
            ...
            if (_twilioSettings.CheckPhoneNumberRegex)
            {
                var match = Regex.Match(phoneNumber, _twilioSettings.PhoneNumberRegex, RegexOptions.IgnoreCase);
            ...
            if (_twilioSettings.CheckIntlDialCode)
            {
                if (!phoneNumber.StartsWith(_twilioSettings.IntlDialCode))
                {
                    if (_twilioSettings.RemoveFirstNDigitsWhenLocalNumber > 0)
                        phoneNumber = phoneNumber[_twilioSettings.RemoveFirstNDigitsWhenLocalNumber..];

                    phoneNumber = _twilioSettings.IntlDialCode + phoneNumber;
                }
            }
        ...
        public virtual async Task<IList<int>> SendCustomerRegisteredNotificationMessageAsync(Customer customer, int languageId)
        {
            ...
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            ...
            foreach (var admin in customers)
            {
                ...
                ids.AddRange(await smsTemplates.SelectAwait(async smsTemplate =>
                {
                    ...
                    await _twiliosmsTokenProvider.AddStoreTokensAsync(tokens, store);
        ...
        public virtual async Task<IList<int>> SendOrderPlacedVendorNotificationAsync(Order order, Vendor vendor, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _twiliosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId, vendor.Id);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendOrderPlacedAdminNotificationAsync(Order order, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _twiliosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendShipmentSentCustomerNotificationAsync(Shipment shipment, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _twiliosmsTokenProvider.AddShipmentTokensAsync(commonTokens, shipment, languageId);
            await _twiliosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendShipmentDeliveredCustomerOTPNotificationAsync(Shipment shipment, string otp, int languageId)
        {
            ...
            await _twiliosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            _twiliosmsTokenProvider.AddOTPTokens(commonTokens, otp);
        ...
        public virtual async Task<IList<int>> SendOrderRefundedAdminNotificationAsync(Order order, decimal refundedAmount, int languageId)
        {
            ...
            var commonTokens = new List<Token>();
            await _twiliosmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _twiliosmsTokenProvider.AddOrderRefundedTokensAsync(commonTokens, order, refundedAmount);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendNewForumTopicMessageAsync(Customer customer, ForumTopic forumTopic, Forum forum, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _twiliosmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopic);
            await _twiliosmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            ...
            Forum forum, int friendlyForumTopicPageIndex, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _twiliosmsTokenProvider.AddForumPostTokensAsync(commonTokens, forumPost);
            await _twiliosmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopics, friendlyForumTopicPageIndex, forumPost.Id);
            await _twiliosmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendPrivateMessageNotificationAsync(PrivateMessage privateMessage, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _twiliosmsTokenProvider.AddPrivateMessageTokensAsync(commonTokens, privateMessage);
            await _twiliosmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);

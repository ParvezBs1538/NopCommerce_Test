...
{
    [Route("api/backinstocksubscription")]
    public class BackInStockSubscriptionApiController : BaseApiController
    {
        #region Fields
        ...
        public BackInStockSubscriptionApiController(CatalogSettings catalogSettings,
        ...
        public virtual async Task<IActionResult> SubscribePopupPOST(int productId)
        {
                ...
                await _productService.GetTotalStockQuantityAsync(product) <= 0)
            {
                ...
                if (subscription != null)
                {
                    ...
                    response.Message = await _localizationService.GetResourceAsync("BackInStockSubscriptions.Notification.Unsubscribed");
                    return Ok(response);
                }
                ...
                {
                    return BadRequest(string.Format(await _localizationService.GetResourceAsync("BackInStockSubscriptions.MaxSubscriptions"),
                ...
                response.Message = await _localizationService.GetResourceAsync("BackInStockSubscriptions.Notification.Subscribed");
                return Ok(response);
            }
        ...
        [HttpGet("customersubscriptions/{pageNumber?}")]
        public virtual async Task<IActionResult> CustomerSubscriptions(int? pageNumber)
        {
            if (_customerSettings.HideBackInStockSubscriptionsTab)
            {
                return BadRequest(await _localizationService.GetResourceAsync("NopStation.WebApi.BackInStockSubscriptions.HideBackInStockSubscriptionsTab"));
            }
        ...
        public virtual async Task<IActionResult> CustomerSubscriptionsPOST([FromBody] BaseQueryModel<string> queryModel)
        {

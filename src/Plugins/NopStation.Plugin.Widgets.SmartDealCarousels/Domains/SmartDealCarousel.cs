...
public partial class SmartDealCarousel : BaseEntity, ILocalizedEntity, IStoreMappingSupported, IAclSupported,
    ...
    ICustomerConditionSupported, ISoftDeletedEntity
{
    ...
    public PositionType PicturePosition
    {
        get => (PositionType)PicturePositionId;
        set => PicturePositionId = (int)value;
    }
}

...
namespace NopStation.Plugin.Widgets.DMS.Extensions
{
    public static class DMSHelperExtension
    {
        ...
        {
            if (httpRequest.Headers.TryGetValue(DMSDefaults.DeviceId_Attribute, out StringValues headerValues))
            {

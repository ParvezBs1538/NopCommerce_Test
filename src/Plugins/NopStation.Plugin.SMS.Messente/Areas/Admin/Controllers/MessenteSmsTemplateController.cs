...
{
    public class MessenteSmsTemplateController : NopStationAdminController
    {
        #region Fields
        ...
        public MessenteSmsTemplateController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Edit(SmsTemplateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.Messente.SmsTemplates.Updated"));

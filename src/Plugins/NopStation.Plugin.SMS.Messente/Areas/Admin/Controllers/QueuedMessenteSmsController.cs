...
{
    public class QueuedMessenteSmsController : NopStationAdminController
    {
        #region Fields
        ...
        public QueuedMessenteSmsController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.Messente.QueuedSmss.Deleted"));

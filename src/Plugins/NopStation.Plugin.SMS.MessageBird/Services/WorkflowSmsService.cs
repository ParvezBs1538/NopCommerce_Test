...
namespace NopStation.Plugin.SMS.MessageBird.Services
{
    public partial class WorkflowSmsService : IWorkflowNotificationService
    {
        ...
        private readonly ISmsTokenProvider _messageBirdsmsTokenProvider;
        ...
        public WorkflowSmsService(ICustomerService customerService,
            ...
            ISmsTokenProvider messageBirdsmsTokenProvider,
            ...
            MessageBirdSettings messageBirdSettings)
        {
            ...
            _messageBirdsmsTokenProvider = messageBirdsmsTokenProvider;
        ...
        protected string GetFormattedPhoneNumber(string phoneNumber)
        {
            ...
            if (_messageBirdSettings.CheckPhoneNumberRegex)
            {
                var match = Regex.Match(phoneNumber, _messageBirdSettings.PhoneNumberRegex, RegexOptions.IgnoreCase);
            ...
            if (_messageBirdSettings.CheckIntlDialCode)
            {
                if (!phoneNumber.StartsWith(_messageBirdSettings.IntlDialCode))
                {
                    if (_messageBirdSettings.RemoveFirstNDigitsWhenLocalNumber > 0)
                        phoneNumber = phoneNumber[_messageBirdSettings.RemoveFirstNDigitsWhenLocalNumber..];

                    phoneNumber = _messageBirdSettings.IntlDialCode + phoneNumber;
                }
            }
        ...
        protected Task<string> GetCustomerPhonenumberAsync(Customer customer, string phoneNumber, Store store)
        {
            if (string.IsNullOrWhiteSpace(phoneNumber))
                phoneNumber = customer.Phone;

            return Task.FromResult(GetFormattedPhoneNumber(phoneNumber));
        }
        ...
        public virtual async Task<IList<int>> SendCustomerRegisteredNotificationMessageAsync(Customer customer, int languageId)
        {
            ...
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);

            var ids = new List<int>();
            var numbers = new List<string>();
            foreach (var admin in customers)
            {
                var phoneNumber = await GetCustomerPhonenumberAsync(admin, "", store);
                ...
                ids.AddRange(await smsTemplates.SelectAwait(async smsTemplate =>
                {
                    ...
                    await _messageBirdsmsTokenProvider.AddStoreTokensAsync(tokens, store);
        ...
        public virtual async Task<IList<int>> SendCustomerWelcomeMessageAsync(Customer customer, int languageId) //can be expanded using different db table
        {
            ...
            var phoneNumber = await GetCustomerPhonenumberAsync(customer, "", store);
            if (string.IsNullOrWhiteSpace(phoneNumber))
                return new List<int>();
        ...
        public virtual async Task<IList<int>> SendOrderPlacedVendorNotificationAsync(Order order, Vendor vendor, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _messageBirdsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId, vendor.Id);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendOrderPlacedAdminNotificationAsync(Order order, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _messageBirdsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendOrderPaidCustomerNotificationAsync(Order order, int languageId)
        {
            ...
            var phoneNumber = await GetCustomerPhonenumberAsync(customer, billingAddress?.PhoneNumber, store);
            if (string.IsNullOrWhiteSpace(phoneNumber))
                return new List<int>();
        ...
        public virtual async Task<IList<int>> SendShipmentSentCustomerNotificationAsync(Shipment shipment, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _messageBirdsmsTokenProvider.AddShipmentTokensAsync(commonTokens, shipment, languageId);
            await _messageBirdsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendShipmentDeliveredCustomerOTPNotificationAsync(Shipment shipment, string otp, int languageId)
        {
            ...
            await _messageBirdsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            _messageBirdsmsTokenProvider.AddOTPTokens(commonTokens, otp);
        ...
        public virtual async Task<IList<int>> SendOrderRefundedAdminNotificationAsync(Order order, decimal refundedAmount, int languageId)
        {
            ...
            var commonTokens = new List<Token>();
            await _messageBirdsmsTokenProvider.AddOrderTokensAsync(commonTokens, order, languageId);
            await _messageBirdsmsTokenProvider.AddOrderRefundedTokensAsync(commonTokens, order, refundedAmount);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, await _customerService.GetCustomerByIdAsync(order.CustomerId));
        ...
        public virtual async Task<IList<int>> SendNewForumTopicMessageAsync(Customer customer, ForumTopic forumTopic, Forum forum, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _messageBirdsmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopic);
            await _messageBirdsmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
            ...
            Forum forum, int friendlyForumTopicPageIndex, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _messageBirdsmsTokenProvider.AddForumPostTokensAsync(commonTokens, forumPost);
            await _messageBirdsmsTokenProvider.AddForumTopicTokensAsync(commonTokens, forumTopics, friendlyForumTopicPageIndex, forumPost.Id);
            await _messageBirdsmsTokenProvider.AddForumTokensAsync(commonTokens, forums);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);
        ...
        public virtual async Task<IList<int>> SendPrivateMessageNotificationAsync(PrivateMessage privateMessage, int languageId)
        {
            ...
            //tokens
            var commonTokens = new List<Token>();
            await _messageBirdsmsTokenProvider.AddPrivateMessageTokensAsync(commonTokens, privateMessage);
            await _messageBirdsmsTokenProvider.AddCustomerTokensAsync(commonTokens, customer);

...
namespace NopStation.Plugin.SMS.MessageBird.Services
{
    public class SmsTokenProvider : ISmsTokenProvider
    {
        ...
        public SmsTokenProvider(CurrencySettings currencySettings,
        ...
        public IEnumerable<string> GetTokenGroups(SmsTemplate smsTemplate)
        {
            ...
            {
                case SmsTemplateSystemNames.CUSTOMER_REGISTERED_NOTIFICATION:
                case SmsTemplateSystemNames.CUSTOMER_WELCOME_MESSAGE:
                case SmsTemplateSystemNames.CUSTOMER_EMAIL_VALIDATION_MESSAGE:
                    return new[] { TokenGroupNames.StoreTokens, TokenGroupNames.CustomerTokens };

                case SmsTemplateSystemNames.ORDER_PLACED_VENDOR_NOTIFICATION:
                case SmsTemplateSystemNames.ORDER_PLACED_ADMIN_NOTIFICATION:
                case SmsTemplateSystemNames.ORDER_PAID_CUSTOMER_NOTIFICATION:
                case SmsTemplateSystemNames.ORDER_PAID_VENDOR_NOTIFICATION:
                case SmsTemplateSystemNames.ORDER_PLACED_CUSTOMER_NOTIFICATION:
                case SmsTemplateSystemNames.ORDER_COMPLETED_CUSTOMER_NOTIFICATION:
                case SmsTemplateSystemNames.ORDER_CANCELLED_CUSTOMER_NOTIFICATION:
                    return new[] { TokenGroupNames.StoreTokens, TokenGroupNames.OrderTokens, TokenGroupNames.CustomerTokens };

                case SmsTemplateSystemNames.SHIPMENT_SENT_CUSTOMER_NOTIFICATION:
                case SmsTemplateSystemNames.SHIPMENT_DELIVERED_CUSTOMER_NOTIFICATION:
                ...
                case SmsTemplateSystemNames.SHIPMENT_DELIVERED_CUSTOMER_OTP_NOTIFICATION:
                ...
                case SmsTemplateSystemNames.ORDER_REFUNDED_ADMIN_NOTIFICATION:
                case SmsTemplateSystemNames.ORDER_REFUNDED_CUSTOMER_NOTIFICATION:
                ...
                case SmsTemplateSystemNames.NEW_FORUM_TOPIC_MESSAGE:
                ...
                case SmsTemplateSystemNames.NEW_FORUM_POST_MESSAGE:
                ...
                case SmsTemplateSystemNames.PRIVATE_MESSAGE_NOTIFICATION:
        ...
        public async Task AddAttributeCombinationTokensAsync(IList<Token> tokens, ProductAttributeCombination combination, int languageId)
        {
            ...
            var attributes = await productAttributeFormatter.FormatAttributesAsync(product, combination.AttributesXml);

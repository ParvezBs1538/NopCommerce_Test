...
{
    public class MessageBirdSmsTemplateController : NopStationAdminController
    {
        #region Fields
        ...
        public MessageBirdSmsTemplateController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Edit(SmsTemplateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.MessageBird.SmsTemplates.Updated"));

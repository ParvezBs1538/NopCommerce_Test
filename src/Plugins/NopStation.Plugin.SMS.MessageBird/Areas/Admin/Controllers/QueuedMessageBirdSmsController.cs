...
{
    public class QueuedMessageBirdSmsController : NopStationAdminController
    {
        #region Fields
        ...
        public QueuedMessageBirdSmsController(IPermissionService permissionService,
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Admin.NopStation.MessageBird.QueuedSmss.Deleted"));

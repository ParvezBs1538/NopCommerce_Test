    ...
    public class SliderHelper
    {
        ...
        public static List<WidgetZoneModel> GetCustomWidgetZoneNameValues()
        {
            ...
            try
            {
                ...
                var filePath = nopFileProvider.Combine(nopFileProvider.MapPath("/Plugins/NopStation.Plugin.Widgets.AnywhereSlider/"), "widgetZones.json");
        ...
        public static List<AnimationTypeModel> GetSliderAnimationTypes()
        {
            ...
            {
                var nopFileProvider = NopInstance.Load<INopFileProvider>();
                var filePath = nopFileProvider.Combine(nopFileProvider.MapPath("/Plugins/NopStation.Plugin.Widgets.AnywhereSlider/"), "animateOptions.json");

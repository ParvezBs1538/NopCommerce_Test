...
{
    public class PushNotificationTemplateSystemNames
    {
        #region Customer
        ...
        #region Cart
        /// <summary>
        /// Represents system name of notification Abandoned Cart
        /// </summary>
        public const string AbandonedCartNotification = "AbandonedCart.CustomerNotification";
        #endregion

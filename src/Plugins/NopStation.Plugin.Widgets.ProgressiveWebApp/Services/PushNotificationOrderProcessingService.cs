...
{
    public class PushNotificationOrderProcessingService : OrderProcessingService
    {
        #region Fields
        ...
        public PushNotificationOrderProcessingService(CurrencySettings currencySettings,

...
{
    public class PWANotificationEventConsumer : IConsumer<CustomerRegisteredEvent>,
        ...
        IConsumer<EntityInsertedEvent<PrivateMessage>>
    {
        ...
        public PWANotificationEventConsumer(IWorkContext workContext,
        ...
        {
            await _workflowNotificationService.SendCustomerRegisteredNotificationMessageAsync(eventMessage.Customer,
        ...
        public async Task HandleEventAsync(EntityInsertedEvent<ForumPost> eventMessage)
        {
            ...
            var friendlyTopicPageIndex = await _forumService.CalculateTopicPageIndexAsync(eventMessage.Entity.TopicId,
                    _forumSettings.PostsPageSize > 0 ? _forumSettings.PostsPageSize : 10, eventMessage.Entity.Id) + 1;

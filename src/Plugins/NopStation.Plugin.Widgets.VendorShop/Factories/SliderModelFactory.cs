...
namespace NopStation.Plugin.Widgets.VendorShop.Factories
{
    public class SliderModelFactory : ISliderModelFactory
    {
        ...
        {
            var cacheKey = _cacheManager.PrepareKeyForDefaultCache(SliderCacheDefaults.GetSliderBackgrounPictureKey(slider.VendorId),
                slider.VendorId,
        ...
        public async Task<SliderListModel> PrepareSliderListModelAsync(int widgetZoneId, int vendorId)
        {
            var zoneIds = new List<int> { widgetZoneId };
            var sliders = await _sliderService.GetAllSlidersAsync(widgetZoneIds: zoneIds, vendorId: vendorId, storeId: _storeContext.GetCurrentStore().Id, active: true);
        ...
        {
            var cacheKey = _cacheManager.PrepareKeyForDefaultCache(SliderCacheDefaults.GetSliderModelKey(slider.VendorId), slider.VendorId, slider, _nopStationContext.MobileDevice,

...
namespace NopStation.Plugin.Widgets.VendorShop.Areas.Admin.Models.ProductTabs
{
    public record ProductTabSearchModel : BaseSearchModel
    {
        ...
        [NopResourceDisplayName("Admin.NopStation.VendorShop.ProductTabs.ProductTabs.List.SearchWidgetZones")]
        public IList<int> SearchWidgetZones { get; set; }

        [NopResourceDisplayName("Admin.NopStation.VendorShop.ProductTabs.ProductTabs.List.SearchStore")]
        public int SearchStoreId { get; set; }

        [NopResourceDisplayName("Admin.NopStation.VendorShop.ProductTabs.ProductTabs.List.SearchActive")]
